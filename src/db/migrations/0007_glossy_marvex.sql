...
ALTER TABLE "posts" ADD COLUMN "push_notified_at" timestamp with time zone;--> statement-breakpoint
...
CREATE INDEX "push_subscriptions_family_user_idx" ON "push_subscriptions" USING btree ("family_id","user_id");